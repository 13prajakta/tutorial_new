                ...
                <ScrollView style={{ flex: 1, backgroundColor: 'white', height: screenHeight }}>
                    ...
                    <SafeAreaView style={{ flex: 1 }}>
                        ...
                        <View style={{ paddingHorizontal: 20, width: '100%', marginBottom: 20 }}>
                            ...
                            <TouchableOpacity style={{ marginLeft: 270, }} onPress={() => firebase.auth().signOut()}><Text style={{ color: 'blue' }}>Logout</Text></TouchableOpacity>
                        </View>
                        ...
                        <View style={{ height: 60, width: '100%', flexDirection: 'row', justifyContent: 'center' }}><Text style={{ color: 'black', fontSize: 19 }}>No Data Has Been Uploaded yet</Text></View>
                             : 
